CREATE DATABASE IF NOT EXISTS empresaplus DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
INSERT INTO departamento (CodDep, CodEmpDir, CodDepDep, CodCen, NomDep, PreAnu, TiDir) VALUES
-- Nivel 1: Dependientes de Dirección General
...
-- Nivel 2: Dependientes de Investigación y Diseño
...
-- Nivel 3: Dependientes de departamentos de nivel 2
...
-- Nivel 4: Dependientes de departamentos de nivel 3
...
-- Nivel 5: Dependientes de departamentos de nivel 4
